...
<head>
    ...
    <link href="../Year%20One/Css/signup.css" rel="stylesheet" type="text/css">
...
<div class="container" >
    ...
    <div class="card card-container" style="background-color: black">
        ...
        <img id="profile-img" class="profile-img-card" src="../Year%20One/images/profile.png"/>
        ...
        <form method = "post" class="form-signin" >
            ...
            <input type="text" class="form-control, inputEmail" name="lastName" placeholder="Last Name" required style="background-color: lightblue; color: white;">

            <input type="text" class="form-control, inputEmail" name="username" placeholder="Username" required style="background-color: lightblue; color: white;">

            <input type="email" class="form-control, inputEmail" name="email" placeholder="Email" required style="background-color: lightblue; color: white;">
            ...
            <input type="text" class="form-control, inputEmail" name="place" placeholder="Where Do You Work?" required style="background-color: lightblue; color: white;">

            <input type="text" class="form-control, inputEmail" name="status" placeholder="Status" required style="background-color: lightblue; color: white;">
